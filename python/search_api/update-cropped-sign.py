...
if __name__ == "__main__":
	...
	# Add a log to save he result in a log file
	log = ""
	logPath = "/home/formation/Documents/TSI/Panoramax"
	...
	for index, row in enumerate(cursor.fetchall()):
		...
		path = "{}/{}".format(croppedSignPath, rowPath)
	...
	with open("{}/logFileUpdate.txt".format(logPath), 'w') as f:
		f.writelines(log)
